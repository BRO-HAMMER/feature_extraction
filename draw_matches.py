...
ap.add_argument("-f", "--first", default="jp_01.png", help="Path to first image")
ap.add_argument("-s", "--second", default="jp_02.png", help="Path to second image")
ap.add_argument("-d", "--detector", type=str, default="SURF", help="Kepyoint detector to use. Options ['BRISK', "
																   "'DENSE', 'DOG', 'SIFT', 'FAST', 'FASTHESSIAN', "
																   "'SURF', 'GFTT', 'HARRIS', 'MSER', 'ORB', 'STAR']")
